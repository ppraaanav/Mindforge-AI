    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden p-4">
      ...
      <div className="glass-panel z-10 w-full max-w-md animate-rise p-8">
        <div className="mb-6 text-center">
          ...
          <p className="mt-1 text-sm text-ink-500">Turn documents into interactive study sessions.</p>
        </div>

        <form onSubmit={onSubmit} className="space-y-4">
          <div>
            <label className="mb-1 block text-xs font-medium uppercase tracking-wide text-ink-500" htmlFor="name">
              Name
            </label>
            <input
              id="name"
